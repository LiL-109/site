window.catalog = [{
    ...
    colors: ['Black', 'Blue'],
    sizes: ['Довільний'],
    thumbnail: 'images/blue1.png', // replace with path to image extracted from catalog layout
    preview: ['images/blue1.png', 'images/blue2.png','images/blue3.png'] // replace with paths to images extracted from item layout
}, {
